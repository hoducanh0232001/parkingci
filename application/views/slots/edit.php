  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Quản lý
        <small>vị trí gửi xe</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
        <li class="active">Quản lý chỗ gửi xe</li>
      </ol>
    </section>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Sửa chỗ gửi xe</h3>
            </div>
            <form role="form" action="<?php base_url('slots/create') ?>" method="post">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('slots/') ?>" class="btn btn-danger">Quay trở lại</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
