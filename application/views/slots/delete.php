...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('groups/') ?>">Quản lý chỗ gửi xe</a></li>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <h1 class="text-danger text-center">Bạn có chắc chắn xoá thông tin này?</h1>
        ...
        <form class="text-center" action="<?php echo base_url('slots/delete/' . $id) ?>" method="post">
          ...
          <a href="<?php echo base_url('slots') ?>" class="btn btn-danger">Huỷ</a>
        </form>
